...
export class Registro {
    ...
    private arrMoto: Vehiculo[]=[];
    private arrCamion: Vehiculo[]=[];

    constructor(auto: Auto[]=[], moto: Vehiculo []=[], camion: Vehiculo []=[]) {
        this.arrAuto = auto;
        this.arrMoto = moto;
    ...
    nuevaMoto(moto: Vehiculo): void {
        this.arrMoto.push(moto);
    }
    nuevoCamion(camion: Vehiculo): void {
